...
{{- printf "postgresdb.%s.svc.%s:%g"  .Release.Namespace .Values.clusterDomain .Values.postgresql.global.postgresql.servicePort -}}
{{- end -}}
...
{{- define "gitea.inline_configuration.defaults.database" -}}
  {{- if .Values.postgresql.enabled -}}
    ...
    {{- end -}}
    # {{- $_ := set .Values.gitea.config.database "HOST"      .Values.postgresql.global.postgresql.postgresqlHost -}}
